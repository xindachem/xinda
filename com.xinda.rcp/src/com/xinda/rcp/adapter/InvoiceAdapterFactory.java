...
public class InvoiceAdapterFactory implements IAdapterFactory {
	...
	private ICustomerProvider customerProvider = new ICustomerProvider() {
		...
		public Customer getCustomer(Object o) {
			return ((Invoice) o).getBook().getCustomer();
		}

	};

	private ITableLabelProvider labelProvider = new InvoiceTableLabelProvider();
